    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Geek Pet!</div>
          <div class="intro-heading text-uppercase">Your Daily Pet Needs</div>
          <!--<div class="intro-lead-in">Click the button below for more info!</div>-->
          @auth
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{URL::to('/home#services')}}">Click Me!!</a>
          @else
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{URL::to('/#services')}}">Click Me!!</a>
          @endauth
        </div>
      </div>
    </header>
